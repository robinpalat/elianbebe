...
Mientras mi pareja se encontraba hospitalizada en maternidad, le informan que su exámen toxicológico arrojó un resultado positivo (más adelante supimos en realidad que fue "presunto positivo"), ella al decirme sorprendida esto por teléfono y al saber nosotros que no tenemos hábito de consumo de drogas, solicitamos inmediatamente otro exámen para corregir el primero. El personal del hospital se negó al principio alegando de que era un test costoso. Pero, después de mucho insistir, una doctora hizo una excepción y gestionó para que se realize un segundo exámen (a dos días del primero), arrojando este un resultado “negativo”.<br>Sin embargo y a modo de sugerir el carácter tendencioso del informe de la funcionaria Carla Jara (Maternidad - hospital El Carmen), hago notar que este segundo resultado no fue dado a conocer en el informe, tampoco la denominación “presunto positivo” del primer resultado, en el informe solo se aplico “positivo para thd” (cannabis). También en ese mismo sentido, en la audiencia preparatoria y por pedido nuestro,  la representante del hospital informo por primera vez el resultado del segundo exámen, aunque “erróneamente”. Informó que suspendieron la lactancia materna porque el negativo era presunto, no el positivo.
...
Traducción del Ingles de la conclusión del articulo:


## Examen de detección de drogas en orina: Guía práctica para médicos
